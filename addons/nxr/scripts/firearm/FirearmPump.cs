...
[Tool]
[GlobalClass]
public partial class FirearmPump : PathInteractable 
{
    ...
    public override void _PhysicsProcess(double delta)
    {
        ...
        if (_firearm.SecondaryGrab.Interactor != null)  {
			Node3D parent = (Node3D)GetParent();
            Transform3D grabXform = _firearm.SecondaryGrab.Interactor.GlobalTransform; 
