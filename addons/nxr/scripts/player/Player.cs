...
{   
    ...
    public override void _Ready()
    {
        ...
        AddChild(_groundRay);
        _groundRay.TargetPosition = Vector3.Down * 10.0f;

        if (_groundRay.IsColliding())
        {
            GlobalPosition = _groundRay.GetCollisionPoint();
        }  
    ...
    {
        return GlobalPosition - GetCamera().GlobalPosition; 
    }

    public void Teleport(Vector3 to)
    {
        GlobalPosition = to + GetOriginOffset();
