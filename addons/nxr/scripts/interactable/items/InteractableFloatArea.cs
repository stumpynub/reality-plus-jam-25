...
public partial class InteractableFloatArea : Area3D
{
	...
	private void OnGrabbed(Interactable interactable, Interactor interactor) { 
		...
		interactable.Freeze = interactable.InitState.FreezeMode;
		interactable.Reparent(interactable.InitState.Parent);
		interactable.Owner = interactable.InitState.Parent;  
